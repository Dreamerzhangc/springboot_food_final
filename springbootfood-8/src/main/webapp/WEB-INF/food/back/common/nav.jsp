		...
		<div class="row">
			<div class="col-md-12">
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
                 <img   src="resources/image/front/logo.jpg" style="height: 50px;width: 80px"/>
					
					<div class="collapse navbar-collapse"
						id="bs-example-navbar-collapse-1">
						<ul class="navbar-nav">
							<li class="nav-item dropdown" style="cursor:default;">
								<a class="nav-link dropdown-toggle" data-toggle="dropdown">后台管理主页</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
									
                                    <!-- 超级管理员可以查看所有模块功能-->									
                                    <c:if test="${sessionScope.manager.role  == 1}">
									<a class="dropdown-item" href="back/toSellerinfo"><span style="color: red;">商家管理</span></a>
									
									<a class="dropdown-item" href="back/productInfoList"><span style="color: red;">新品管理</span></a>
									<a class="dropdown-item" href="back/productInfoList"><span style="color: red;">管理员管理</span></a>
									</c:if>
									<a class="dropdown-item" href="back/toOrderList"><span style="color: red;">订单管理</span></a> 
									<a class="dropdown-item" href="back/productInfoList"><span style="color: red;">商品管理</span></a>
								</div>
							</li>
						</ul>
						<ul class="navbar-nav ml-md-auto">
							<li ><span>欢迎<b style="color: blue;">${sessionScope.manager.username}</b>登录&nbsp;&nbsp;&nbsp;&nbsp;</span></li>
