...
<body style="background-image:url('resources/image/4.jpg'); ">
	...
	<div class="container-fluid" style="width: 30%; padding: 50px; border: solid, black, 1px;  background-size: 100%;background-color: #f0f8ff;" >
		<div class="row">
			<div class="col-md-12">
				<c:if test="${msg!=null }">
				...
				<form role="form" action="back/login" method="post">
					...
					<div class="form-group row">
						...
						<div class="form-group row" style="margin-bottom: 0px">
							<label class="radio-inline" style="margin-left: 120px;margin-right: 5px">
						<input type="radio" value="0" name="role"  checked="checked">管理员 </label>
						<label class="radio-inline" style="margin-left: 60px;margin-right: 5px">
						<input type="radio" value="1" name="role" >超级管理员 </label>
						</div>
					

					<button type="submit" class="btn btn-success" style="width:230px; margin-left: 95px">登录</button>
				</form>
			</div>
		</div>
	</div>
