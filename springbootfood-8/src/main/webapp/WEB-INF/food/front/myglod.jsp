				...
				<div class="row mx-auto" style="width: 100%">
					...
					<div class="row mx-auto text-center col-md-12"
						...
						<div class="col-md-6"
							...
							<h4 class="text-left">我的积分</h4>
							<span style="font-size: h6">使用说明：&nbsp;&nbsp;&nbsp;<a style="color: blue;">1000积分抵10元</a></span>
					...
					<div class=""
						...
						<span style="font-size: h6">当前账户积分</span> <span
							style="padding-left: 50px"><a style="color: blue;">&nbsp;&nbsp;&nbsp;2
								积分</a></span>
					</div>
					<!-- 顶部导航栏结束 -->
					<div class="col-md-12">
						...
						<div class="row mx-auto text-center"
							...
							<div
								...
								<h6 class="text-left">最近一个月积分记录</h6>
							...
							<table class="table table-hover mx-auto" style="width: 90%;">
								...
								<thead class="col-md-12">
									<tr class="row" style="background:#FFF8DC; height: 50px">
										...
										<th class=" col-md-2 col-1 text-center">积分分数</th>
								...
								<tbody class="col-md-12">
									...
									<tr class="row" style="height: 50px">
										...
										<td class="col-md-4 col-1 text-center">下单赠送 
										</td>
										<td class="col-md-2 col-1 text-center">2</td>


										<td class="col-md-2 col-1 text-center">下单赠送积分</td>
