			...
			<div class="col-md-12">
				...
				<div class="row mx-auto text-center"
					...
					<div
						...
						<span><a style="color: blue;" href="front/mymoney">查看</a></span>
					</div>

					<div
						style="padding-left: 40px; padding-right: 15px; padding-top: 38px; border: px solid white;">
						<h4 class="text-left">我的积分</h4>
						<span><a style="color: blue;" href="front/myglod">查看</a></span>
					</div>
					<div
						style="padding-left: 40px; padding-right: 15px; padding-top: 38px; border: px solid white;">
						<h4 class="text-left">我的红包</h4>
						<span><a style="color: blue;" href="front/mypacket">查看</a></span>
					</div>
