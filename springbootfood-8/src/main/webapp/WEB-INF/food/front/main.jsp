			...
			<div class="col-md-2"  style="background-color: #f5f5f5 ;">
				<div class="row" style="background-color: rgb(0, 137, 220);">
					  ...
					  <div class="col-12" style="padding: 0px;">
					  	<div style="height: 60px;color: red;line-height: 60px;" class="auto-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商家排行榜</div>
					    <div class="list-group" >
						  <%-- <c:forEach items="${productTypes }" var="type">
						  <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: black ;" >&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" >${type.typeName}</a>
						 </div>
						  </c:forEach>	 --%>					  
						 <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: red ;" >&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">豪胜牛排</span></a>
						 </div>
						 <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: blue ;" >&nbsp;&nbsp;&nbsp;2 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">成都风味</span></a>
						 </div>
						 <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: green ;" >&nbsp;&nbsp;&nbsp;3 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">叫了只炸鸡</span></a>
						 </div>
						 <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: yellow ;" >&nbsp;&nbsp;&nbsp;4 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">宴遇1977</span></a>
						 </div>
						  <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: black ;" >&nbsp;&nbsp;&nbsp;5 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">必胜客</span></a>
						 </div>
						<div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: black ;" >&nbsp;&nbsp;&nbsp;6 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">兄弟饭庄</span></a>
						 </div>
						 <div style="height: 60px;color: white;line-height: 60px;background-color:rgb(255, 228, 225);color: black ;" >&nbsp;&nbsp;&nbsp;7 &nbsp;&nbsp;&nbsp; 
						 <a href="front/productInfoList?productType=${type.id }" ><span style="color: black;">张亮麻辣烫</span></a>
						 </div>
						</div>
					  </div>
