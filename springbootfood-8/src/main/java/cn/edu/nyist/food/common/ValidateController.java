package cn.edu.nyist.food.common;
...
public class ValidateController {
	...
	public static final String SERVER_VCODE="validateCode";
	
	@RequestMapping(path="/vcode.png")
	public void getVcode(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		session.setAttribute(SERVER_VCODE, randomCode.toString()); 
